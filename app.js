...
function UpdateDevicesArray() {
    ...
    for (var i in devicesArray) {
        ...
        if (devicesArray[i].id == 4002){devicesArray[i].val = t_K1;}
        if (devicesArray[i].id == 4003){devicesArray[i].val = t_K2;}
        if (devicesArray[i].id == 4004){devicesArray[i].val = t_B1;}
        if (devicesArray[i].id == 4005){devicesArray[i].val = t_B2;}
        if (devicesArray[i].id == 4006){devicesArray[i].val = t_B3;}
        if (devicesArray[i].id == 4009){devicesArray[i].val = t_G2;}
        if (devicesArray[i].id == 4008){devicesArray[i].val = t_BU;}
        if (devicesArray[i].id == 4007){devicesArray[i].val = t_G1;}
        if (devicesArray[i].id == 4001){devicesArray[i].val = t_WK;}
