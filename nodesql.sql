...
--
-- Host: localhost
-- Generation Time: Feb 20, 2014 at 10:42 PM
...
CREATE TABLE IF NOT EXISTS `device_ini` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4011 ;
...
(4008, 'Buiten', 0, 4, '28-00000494bd4b', 0, '', 0, 0, 0, 0),
(4009, 'NachtL1', 0, 3, 'input', 0, 'P9_21', 0, 9, 0, 0),
(4010, 'NachtL2', 0, 3, 'input', 0, 'P9_23', 0, 8, 0, 0);
