var window_pref="";
window_pref +="<div class='window' style='height:300px;width:230px;'>";
window_pref +="    <nav>";
...
window_pref +="     <label class='tasks-list-item'>";
window_pref +="		<span class='tasks-list-desc'>Temp 1</span>";
...
window_pref +="	 </label>  ";
window_pref +="     <label class='tasks-list-item'>";
window_pref +="    	<span class='tasks-list-desc'>Start temp script</span>";
...
window_pref +="	 </label>  ";
window_pref +="     <label class='tasks-list-item'>";
window_pref +="        <span class='tasks-list-desc'>Reload serverDB</span>";
